...
<table>
  <tr>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/home_light.png" alt="Home Screen Light" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
      <em>Clean, intuitive home screen interface with game mode selection</em>
    </td>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/home_dark_green.png" alt="Home Screen Dark" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
      <em>Dark theme variant showcasing adaptive UI design</em>
    </td>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/question_dark_green.png" alt="Game Question Interface" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
  ...
  <tr>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/lobby_light.png" alt="Game Lobby" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
      <em>Multiplayer game lobby showing waiting players and match configuration</em>
    </td>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/leaderboard_light.png" alt="Leaderboard System" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
      <em>Global leaderboard with ranking system and player statistics</em>
    </td>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/game_results_light.png" alt="Game Results" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
  ...
  <tr>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/duel_results_light.png" alt="Duel Results" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
      <em>Head-to-head duel results showing competitive match outcomes</em>
    </td>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/profile_dark_red.png" alt="User Profile" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
      <em>Comprehensive user profile with achievements, statistics, and customization options</em>
    </td>
    <td style="text-align: center; vertical-align: top;">
      <img src="/assets/img/flutter-app/activity_light.png" alt="Activity Tracking" style="width:100%; max-width:200px; display: block; margin-left: auto; margin-right: auto;">
      <br>
